...
function render() {
  ...
  document.title = language === "zh" ? "推文雷达 Tweet Radar — 用 Jev 按你的标准筛选 X" : "Tweet Radar — Filter X with your own criteria using Jev";
  for (const el of document.querySelectorAll("[data-i18n]")) {
    if (el.dataset.i18n === "title") el.innerHTML = t.title;
    else el.textContent = t[el.dataset.i18n];
  }
  document.getElementById("language").textContent = language === "zh" ? "English" : "简体中文";
